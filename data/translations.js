const translations = {
  ...
  english: {
    ...
    rsvpSubtitle: "Let us know you're coming — it only takes a moment.",
    nameLabel: "Your Name",
    guestsLabel: "Number of Guests",
    rsvpButton: "Send RSVP",
    rsvpSuccess: "Thank you! Your RSVP has been saved ❤️",
    button: "RSVP Now",

    shareBtn: "📤 Share",
    shareTitle: "Amaziya First Birthday 🎂",
    shareText: "Join us for Amaziya's First Birthday Celebration 🎉",
  ...
  amharic: {
    ...
    rsvpButton: "ላክ",
    rsvpSuccess: "አመሰግናለሁ! መገኘትዎ ተመዝግቧል ❤️",
    button: "መገኘትዎን ያሳውቁ",

    shareBtn: "📤 አጋራ",
    shareTitle: "የአማዚያ የመጀመሪያ ልደት 🎂",
    shareText: "የአማዚያን የመጀመሪያ ልደት በዓል ይቀላቀሉን 🎉",
    shareCopied: "✓ ሊንክ ተቀድቷል!",
